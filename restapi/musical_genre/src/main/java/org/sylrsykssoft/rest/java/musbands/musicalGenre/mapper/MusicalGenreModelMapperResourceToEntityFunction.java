 ...
 * 
 */
package org.sylrsykssoft.rest.java.musbands.musicalGenre.mapper;
 ...
 *
 */
public class MusicalGenreModelMapperResourceToEntityFunction
		extends BaseAdminModelMapperResourceToEntityFunction<MusicalGenreResource, MusicalGenre> {
